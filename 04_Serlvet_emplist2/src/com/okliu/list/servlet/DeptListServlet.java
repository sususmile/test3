...
public class DeptListServlet extends HttpServlet{
    ...
    protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        out.println("</head>");
        out.println("<body>");
        out.println("<h1 align=\"center\">部门管理系统</h1>");
        out.println("<p align=\"center\"><a href=\"deptAdd.html\">添加部门</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href=\"empList.do\">员工管理</a></p>");
        out.println("    <table border=\"1\" width=\"600\" align=\"center\">");
        out.println("        <tr><th>部门编号</th><th>部门名称</th><th>操作</th></tr>");
